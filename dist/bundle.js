...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsApp = __webpack_require__(/*! ./components/App */ 161);
	...
	var _storesPlayersStore = __webpack_require__(/*! ./stores/PlayersStore */ 168);
	
	var _storesPlayersStore2 = _interopRequireDefault(_storesPlayersStore);
	
	var _storesLineupStore = __webpack_require__(/*! ./stores/LineupStore */ 169);
	
	var _storesLineupStore2 = _interopRequireDefault(_storesLineupStore);
	
	_reactor2['default'].registerStores({
	  lineup: _storesLineupStore2['default'],
	  players: _storesPlayersStore2['default']
	});
	
	_actions2['default'].fetchPlayers();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _actionTypes = __webpack_require__(/*! ./actionTypes */ 4);
	
	exports['default'] = {
	  fetchPlayers: function fetchPlayers() {
	    var players = [{ id: 1, name: 'Shabananana', salary: 6789, display: true, inLineup: false }, { id: 2, name: 'jefe', salary: 1, display: true, inLineup: false }, { id: 3, name: 'Kiba', salary: 456, display: true, inLineup: false }, { id: 4, name: 'Mctest', salary: 888, display: true, inLineup: false }];
	    _reactor2['default'].dispatch(_actionTypes.RECEIVE_PLAYERS, { players: players });
	  },
	  addPlayer: function addPlayer(player) {
	    _reactor2['default'].dispatch(_actionTypes.ADD_PLAYER, { player: player });
	  },
	  removePlayer: function removePlayer(player) {
	    _reactor2['default'].dispatch(_actionTypes.REMOVE_PLAYER, { player: player });
	  },
	  clearLineup: function clearLineup(players) {
	    _reactor2['default'].dispatch(_actionTypes.CLEAR_LINEUP, { players: players });
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _nuclearJs = __webpack_require__(/*! nuclear-js */ 3);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactLibKeyMirror = __webpack_require__(/*! react/lib/keyMirror */ 5);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var keyMirror = __webpack_require__(/*! ./keyMirror */ 5);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LineupContainer = __webpack_require__(/*! ./LineupContainer */ 162);
	
	var _LineupContainer2 = _interopRequireDefault(_LineupContainer);
	
	var _PlayersContainer = __webpack_require__(/*! ./PlayersContainer */ 167);
...
/* 162 */
/*!**********************************************!*\
  !*** ./client/components/LineupContainer.js ***!
  \**********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _commonComponentsPlayer = __webpack_require__(/*! ../../common/components/Player */ 164);
	
	var _commonComponentsPlayer2 = _interopRequireDefault(_commonComponentsPlayer);
	
	var _commonComponentsPlayersList = __webpack_require__(/*! ../../common/components/PlayersList */ 165);
	
	var _commonComponentsPlayersList2 = _interopRequireDefault(_commonComponentsPlayersList);
	
	var _getters = __webpack_require__(/*! ../getters */ 166);
	...
	exports['default'] = _react2['default'].createClass({
	  ...
	  getDataBindings: function getDataBindings() {
	    return {
	      lineup: _getters2['default'].lineupPlayers,
	      total: _getters2['default'].lineupSalaryTotal
	    };
	  },
	
	  onClearClick: function onClearClick() {
	    _actions2['default'].clearLineup(this.state.lineup);
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Lineup = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var nodes = !hasPlayers ? React.createElement(
	      'div',
	      null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Player = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      'div',
	      { className: 'uk-panel uk-panel-box uk-margin-bottom ' + (this.props.player.display || this.props.player.inLineup ? 'active' : 'hide') },
	      React.createElement(
	        'h4',
	        { className: 'uk-h4' },
	        player.title,
...
/* 165 */
/*!******************************************!*\
  !*** ./common/components/PlayersList.js ***!
  \******************************************/
/***/ function(module, exports, __webpack_require__) {
...
/***/ function(module, exports) {
	...
	var lineupPlayers = [['players'], ['lineup', 'playerSalary'], function (players, playerSalary) {
	  return playerSalary.map(function (salary, playerId) {
	    var player = players.get(playerId);
	    return player.set('inLineup', true).remove('display'); // display shouldn't be known in cart
	  }).toList();
	}];
	
	var lineupSalaryTotal = [lineupPlayers, function (players) {
	...
	exports['default'] = { players: players, lineupPlayers: lineupPlayers, lineupSalaryTotal: lineupSalaryTotal };
	module.exports = exports['default'];

/***/ },
/* 167 */
/*!***********************************************!*\
  !*** ./client/components/PlayersContainer.js ***!
  \***********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = _react2['default'].createClass({
	  ...
	  getDataBindings: function getDataBindings() {
	    return {
	      players: _getters2['default'].players
	    };
	  },
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = (0, _nuclearJs.Store)({
	  ...
	  initialize: function initialize() {
	    this.on(_actionTypes.RECEIVE_PLAYERS, receivePlayers);
	    this.on(_actionTypes.ADD_PLAYER, hidePlayer);
	    this.on(_actionTypes.REMOVE_PLAYER, displayPlayer);
	    this.on(_actionTypes.CLEAR_LINEUP, displayPlayers);
	  }
	});
	 ...
	 */
	function receivePlayers(state, _ref) {
	  var players = _ref.players;
	
	  var newPlayers = (0, _nuclearJs.toImmutable)(players).toMap().mapKeys(function (k, v) {
	    return v.get('id');
	  });
	 ...
	 */
	function hidePlayer(state, _ref2) {
	  var player = _ref2.player;
	
	  return state.update(player.id, function (player) {
	 ...
	 */
	function displayPlayer(state, _ref3) {
	 ...
	 */
	function displayPlayers(state, _ref4) {
	  var players = _ref4.players;
	
	  return state.update(players, players.map(function (player) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = (0, _nuclearJs.Store)({
	  getInitialState: function getInitialState() {
	    return (0, _nuclearJs.toImmutable)({ playerSalary: {} });
	  },
	
	  initialize: function initialize() {
	    this.on(_actionTypes.ADD_PLAYER, addPlayer);
	    this.on(_actionTypes.REMOVE_PLAYER, removePlayer);
	    this.on(_actionTypes.CLEAR_LINEUP, clearLineup);
	  }
	});
	
	function addPlayer(state, _ref) {
	  var player = _ref.player;
	
	  var id = player.id;
	  return state.setIn(['playerSalary', id], (0, _nuclearJs.toImmutable)(player));
	}
	
	function removePlayer(state, _ref2) {
	  var player = _ref2.player;
	
	  return state.deleteIn(['playerSalary', player.id]);
	}
	
	function clearLineup(state, _ref3) {
	  _objectDestructuringEmpty(_ref3);
	
	  return state.clear().set((0, _nuclearJs.toImmutable)({ playerSalary: {} }));
	}
	module.exports = exports['default'];

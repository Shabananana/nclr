...
/***/ function(module, exports, __webpack_require__) {
	...
	var _containersApp = __webpack_require__(157);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PlayersApp = __webpack_require__(158);
	
	var _PlayersApp2 = _interopRequireDefault(_PlayersApp);
	...
	var _storesPlayersStoreExport = __webpack_require__(204);
	
	var playersStore = _interopRequireWildcard(_storesPlayersStoreExport);
	
	var redux = (0, _redux.createRedux)(playersStore);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        { redux: redux },
	        function () {
	          return _react2['default'].createElement(_PlayersApp2['default'], null);
	        }
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _componentsPlayersContainer = __webpack_require__(184);
	
	var _componentsPlayersContainer2 = _interopRequireDefault(_componentsPlayersContainer);
	
	var PlayersApp = (function (_Component) {
	  _inherits(PlayersApp, _Component);
	
	  function PlayersApp() {
	    _classCallCheck(this, PlayersApp);
	
	    _get(Object.getPrototypeOf(PlayersApp.prototype), 'constructor', this).apply(this, arguments);
	  }
	
	  _createClass(PlayersApp, [{
	    key: 'render',
	    value: function render() {
	      return _react2['default'].createElement(
	    ...
	    value: function renderChild(_ref) {
	      ...
	      return _react2['default'].createElement(
	        'div',
	        null,
	        _react2['default'].createElement(_componentsPlayersContainer2['default'], { players: players, actions: actions })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _middlewareThunk = __webpack_require__(167);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.clearLineup = clearLineup;
...
/***/ function(module, exports) {
	...
	var CLEAR_LINEUP = 'CLEAR_LINEUP';
	exports.CLEAR_LINEUP = CLEAR_LINEUP;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _commonComponentsPlayer = __webpack_require__(185);
	
	var _commonComponentsPlayer2 = _interopRequireDefault(_commonComponentsPlayer);
	
	var PlayersContainer = (function (_Component) {
	  _inherits(PlayersContainer, _Component);
	
	  _createClass(PlayersContainer, null, [{
	    key: 'propTypes',
	    value: {
	  ...
	  function PlayersContainer(props, context) {
	    _classCallCheck(this, PlayersContainer);
	
	    _get(Object.getPrototypeOf(PlayersContainer.prototype), 'constructor', this).call(this, props, context);
	  }
	
	  _createClass(PlayersContainer, [{
	    key: 'render',
	    value: function render() {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          players.map(function (player) {
	            return _react2['default'].createElement(_commonComponentsPlayer2['default'], _extends({ player: player }, actions));
	          })
	        )
	      );
	    }
	...
	exports['default'] = PlayersContainer;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAddons = __webpack_require__(186);
	...
	var Player = (function (_Component) {
	  ...
	  _createClass(Player, null, [{
	    ...
	    get: function get() {
	      return {
	        ...
	        addPlayer: _reactAddons.PropTypes.func.isRequired
	      };
	    }
	  }]);
	  ...
	  _createClass(Player, [{
	    ...
	    value: function render() {
	      ...
	      var addPlayer = _props.addPlayer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactCSSTransitionGroup = __webpack_require__(192);
	var ReactFragment = __webpack_require__(10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactElement = __webpack_require__(11);
	var ReactPropTransferer = __webpack_require__(196);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PlayersStore = __webpack_require__(205);
	
	exports.players = _interopRequire(_PlayersStore);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var initialState = [{ id: 1, name: 'Shabananana', salary: 6789, display: true, inLineup: false }, { id: 2, name: 'jefe', salary: 1, display: true, inLineup: false }, { id: 3, name: 'Kiba', salary: 456, display: true, inLineup: false }, { id: 4, name: 'Mctest', salary: 888, display: true, inLineup: false }];
	...
	function players(state, action) {
	  ...
	  switch (action.type) {
	    ...
	    case _actionTypes.ADD_PLAYER:
	      return state.filter(function (player) {
	        return player.id !== action.player.id;
	      });
	
	    case _actionTypes.REMOVE_PLAYER:
	      return [player].concat(_toConsumableArray(state));
	
	    case _actionTypes.CLEAR_LINEUP:
	      return [players].concat(_toConsumableArray(state));
